...
const magician_name = [ "ali", "khalid", "wakil", "amjad"];

function make_great()  {
    const clone = [].concat(magician_name);
    console.log(clone);     // clone of array and orignal array is not changed
